import cv2
from detect import AccidentDetectionModel
import numpy as np
import os
import winsound
import threading
...
# Import PIL modules for image handling
...
def call_ambulance():
    try:
        ...
        call = client.calls.create(
            url="twilio_handler_url",  
            # Sample TwiML URL
            to="sender_number",  
            # add verified ambulance number 
...
def show_alert_message():
    ...
    # Adjust window size to fit the GIF and message box
